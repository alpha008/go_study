...
127.0.0.1
13306
root:123456@tcp(127.0.0.1:3306)/gorm1?charset=utf8mb4&parseTime=True&loc=Local
...
[GIN-debug] POST   /apis/v1/register         --> gin-jwt/controller.RegisterUser (3 handlers)
[GIN-debug] POST   /apis/v1/login            --> gin-jwt/controller.Login (3 handlers)
[GIN-debug] GET    /apis/v1/auth/time        --> gin-jwt/controller.GetDataByTime (4 handlers)
